                ...
                <nav className="flex w-full items-center justify-between p-4 ">
                    ...
                    <div className="flex h-full items-center">
                        ...
                        <button className="ml-10 flex items-center space-x-0.5" onClick={toggleAudio}>
                            <audio ref={audioRef} className="hidden" loop src="../../../assets/audio/loop.mp3">
                                {[1, 2, 3, 4].map((bar, index) => (
                                    <div key={index} className={`indicator-line ${isIndicatorActive ? 'active' : ''}`} style={{ animationDelay: `${bar * 0.1}s` }}>
